...
big_example_in = '''on x=-5..47,y=-31..22,z=-19..33
...
def test_firststep():
    parser = day22.InputParser("on x=10..12,y=10..12,z=10..12")
    instructions = parser.parse()
    reactor = day22.Reactor()
    reactor.central_reboot(instructions)
    assert 27 == reactor.lit_cubes()
...
def test_bigexample():
    ...
    reactor = day22.Reactor()
    reactor.central_reboot(instructions)
    assert 590784 == reactor.lit_cubes()

def test_bigbigexample():
    parser = day22.InputParser(big_example_in)
    instructions = parser.parse()
    reactor = day22.Reactor()
    reactor.full_reboot(instructions)
    assert 2758514936282235 == reactor.lit_cubes()
