...
def test_vectormap1():
    scanners = day19.parse_input(example_in)
    scanner = scanners[0]
    assert len(scanner.vector_map()) == 25

def test_overlaps1():
    scanners = day19.parse_input(example_in)
    r = scanners[0].get_overlaps(scanners[1])
    assert len(r) == 12


def test_overlaps2():
    scanners = day19.parse_input(example_in)
    r = scanners[1].get_overlaps(scanners[4])
    assert len(r) == 12
